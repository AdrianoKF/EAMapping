...
import org.dslab.mdsd4sil.metamodel.enterprisearchitect.datatypes.*;
...
public class GraphTransformerTest {
	...
	public void testEmptyGraph() {
		...
		final Graph<ModelObject, Connector> graph = gt.transformToGraph(
	...
	public void testCompleteGraph() {
		...
		final GraphTransformer gt = new GraphTransformer(nodes);
		final ListenableDirectedGraph<ModelObject, Connector> graph = gt
