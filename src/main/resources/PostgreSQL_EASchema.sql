...
CREATE TABLE t_attribute (
   ...
   Notes	    	TEXT,
   Derived	    	CHAR(1),
   ID		    	INTEGER DEFAULT NEXTVAL(('"id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
   Pos		    	INTEGER,
   GenOption	    TEXT,
   Length	    	INTEGER,
   Precision	    INTEGER,
...
CREATE TABLE t_attributetag (
   PropertyID	INTEGER DEFAULT NEXTVAL(('"propertyid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
   ElementID	INTEGER,
...
CREATE TABLE t_category (
   CategoryID   INTEGER DEFAULT NEXTVAL(('"categoryid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
   Name         VARCHAR(255),
   Type         VARCHAR(255),
   NOTES        TEXT
);
...
CREATE TABLE t_connector (
   Connector_ID       INTEGER DEFAULT NEXTVAL(('"connector_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
   Name               VARCHAR(255),
...
CREATE TABLE t_datatypes ( 
	...
	DatatypeID    INTEGER DEFAULT NEXTVAL(('"datatypeid_seq"'::text)::regclass) NOT NULL PRIMARY KEY
);
...
CREATE TABLE t_diagram ( 
	Diagram_ID          INTEGER DEFAULT NEXTVAL(('"diagram_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
...
CREATE TABLE t_diagramlinks ( 
	...
	Path        VARCHAR(255),
	Instance_ID INTEGER DEFAULT NEXTVAL(('"instance_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY
);
...
CREATE TABLE t_glossary ( 
	...
	Type        VARCHAR(255),
	Meaning     TEXT,
	GlossaryID  INTEGER DEFAULT NEXTVAL(('"glossaryid_seq"'::text)::regclass) NOT NULL PRIMARY KEY
);
...
CREATE TABLE t_image ( 
	ImageID INTEGER DEFAULT NEXTVAL(('"imageid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Name    VARCHAR(255),
	Type    VARCHAR(255),
	Image   BYTEA
);
...
CREATE TABLE t_issues ( 
	...
	Resolution      TEXT,
	IssueID         INTEGER DEFAULT NEXTVAL(('"issueid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
...
CREATE TABLE t_object ( 
	Object_ID       INTEGER DEFAULT NEXTVAL(('"object_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
...
CREATE TABLE t_objectrequires ( 
	ReqID       INTEGER DEFAULT NEXTVAL(('"reqid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Object_ID   INTEGER DEFAULT 0,
...
CREATE TABLE t_operation ( 
	OperationID  INTEGER DEFAULT NEXTVAL(('"operationid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Object_ID    INTEGER DEFAULT 0,
	Name         VARCHAR(255),
	Scope        VARCHAR(50),
	Type         VARCHAR(255),
...
CREATE TABLE t_package ( 
	Package_ID   INTEGER DEFAULT NEXTVAL(('"package_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Name         VARCHAR(255),
...
CREATE TABLE t_palette ( 
	PaletteID INTEGER DEFAULT NEXTVAL(('"paletteid_seq"'::text)::regclass) NOT NULL,
	Name      VARCHAR(255),
	Type      VARCHAR(255)
);
...
CREATE TABLE t_script ( 
	ScriptID        INTEGER DEFAULT NEXTVAL(('"scriptid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
...
CREATE TABLE t_tasks ( 
	TaskID      INTEGER DEFAULT NEXTVAL(('"taskid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Name        VARCHAR(255),
...
CREATE TABLE t_trxtypes ( 	
	...
	Notes         TEXT,
	TRX           VARCHAR(255),	
	TRX_ID        INTEGER DEFAULT NEXTVAL(('"trx_id_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
	Style TEXT
);
...
CREATE TABLE t_umlpattern ( 
	PatternID       INTEGER DEFAULT NEXTVAL(('"patternid_seq"'::text)::regclass) NOT NULL PRIMARY KEY,
